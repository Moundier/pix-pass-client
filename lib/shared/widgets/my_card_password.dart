...
class MyCardPassword extends StatelessWidget {
  ...
  void _clipboard(BuildContext context, String text) {
          ...
          children: <Widget>[
            ...
            Align(
              ...
              child: Padding(
                ...
                child: MyNesIconButton(
                  image: Image.asset('assets/images/clipboard.png', height: 34,),  // INFO: Execute clipboard
                  onPress: () => _clipboard(context, password.title ?? ''),
                ),
              )
            ),
            ...
            Align(
              ...
              child: Padding(
                ...
                child: NesIconButton(
                  primaryColor: const Color.fromARGB(255, 119, 1, 1),
